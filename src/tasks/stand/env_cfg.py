...
from .mdp.actions import StandPositionActionCfg
from .mdp.commands import StandCommandCfg
...
def stand_env_cfg(play=False):
  ...
  return ManagerBasedRlEnvCfg(
    ...
    actions={'joint_pos': StandPositionActionCfg(entity_name='robot')},
    observations={
    ...
    commands={'stand': StandCommandCfg(resampling_time_range=(10., 10.))},
    events=event_terms,
